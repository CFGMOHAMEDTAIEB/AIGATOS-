...
export function AuditPage(){
  ...
  if(!activeSimulationId)return <><PageHeader eyebrow="Traçabilité" title="Historique d’audit" description="Aucun contexte opérationnel sélectionné."/><Alert severity="info" action={<Button component={RouterLink} to="/campaigns" color="inherit">Choisir une campagne</Button>}>L’audit affiche uniquement les événements réellement enregistrés pour le contexte actif.</Alert></>
