...
import {
  AppBar, Avatar, Box, Chip, Divider, Drawer, FormControl, IconButton, InputLabel,
...
export function Layout(){
  ...
  const {contexts,active,activeSimulationId,selectSimulation}=useOperationalSession()
  ...
  return <Box sx={{display:'flex',minHeight:'100vh'}}>
    ...
    <Box component="main" className="app-main" sx={{flexGrow:1,width:{md:`calc(100% - ${width}px)`},pt:{xs:'102px',md:'118px'},pb:7,px:{xs:2,sm:3,lg:5}}}><Box maxWidth={1480} mx="auto"><Outlet/></Box></Box>
  </Box>
}
